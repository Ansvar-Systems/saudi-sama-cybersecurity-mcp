/**
 * SQLite database access layer for the Saudi SAMA Cybersecurity MCP server.
 *
 * Schema:
 *   - frameworks  — SAMA cybersecurity and risk management frameworks
 *   - controls    — Individual controls within each framework
 *   - circulars   — SAMA regulatory circulars and IT governance notices
 *
