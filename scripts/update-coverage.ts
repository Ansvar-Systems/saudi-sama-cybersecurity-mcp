    ...
    sources: [
      {
        ...
        access_method: {
          ...
          tunnel_host: "dev.ansvar.eu",
          geo_block: true,
          notes:
            "SAMA geo-blocks EU datacentre egress IPs; ingestion runs through an SSH SOCKS5 " +
            "tunnel via the Ansvar dev server (135.181.100.113). NordVPN has no Saudi exit " +
            "nodes. All future refreshes must use this tunnel.",
        },
      },
    ],
